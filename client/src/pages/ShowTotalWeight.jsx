                    ...
                    {products.map((product,index) => {
                        ...
                        if(parseInt(product.building_no) === parseInt(buildingNo)){
                            if( monthYear.substring(5,7) === product.date[0].substring(5,7) && 
                                ...
                                countTotalGuestsInDayInterval = countTotalGuestsInDayInterval + product.seven_to_twelve_months_age
                                + product.one_to_two_years_age + product.three_to_six_years_age +
                                product.seven_to_twelve_years_age + product.thirteen_or_higher_age;
                                countTotalGram = product.seven_to_twelve_months_gr * product.seven_to_twelve_months_age +
                                product.one_to_two_years_gr * product.one_to_two_years_gr + 
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>{product.one_to_two_years_gr * product.one_to_two_years_gr}</td>
